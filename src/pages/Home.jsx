    ...
    <div className="bg-[#F4F4F5] text-slate-900 min-h-screen selection:bg-slate-200 overflow-x-hidden font-sans">
      <nav
        className={`fixed top-8 left-1/2 -translate-x-1/2 z-50 transition-all duration-500 ${
          scrolled ? "w-[90%] md:w-[400px]" : "w-[95%] md:w-[600px]"
        }`}
      >
        <div
          className="bg-slate-900 border border-slate-800 shadow-xl rounded-full px-8 py-4 flex justify-between items-center"
          {...fadeIn({
            direction: "up",
            distance: 80,
            duration: 0.9,
      ...
      <section className="min-h-screen flex flex-col justify-center px-6 lg:px-24 relative pt-20">
        <div className="grid lg:grid-cols-2 gap-16 items-center relative z-10 max-w-7xl mx-auto w-full">
          <motion.div
          ...
          >
            <div className="flex items-center gap-4 mb-8">
              <span className="px-3 py-1 bg-slate-900 text-white rounded-md font-mono text-[10px] font-bold tracking-widest uppercase italic">
                Graduated '25
              </span>
              <span className="text-slate-400 font-mono text-[10px] tracking-[0.3em] uppercase">
                GCE KANNUR
              </span>
            </div>
            <h1
              className="text-7xl md:text-9xl font-black tracking-tighter leading-[0.85] mb-10 text-slate-950"
              {...fadeIn({
                direction: "right",
                distance: 80,
                duration: 0.9,
            ...
            <p
              className="max-w-md text-slate-600 text-xl leading-relaxed mb-12 font-medium"
              {...fadeIn({
                direction: "up",
                distance: 80,
                duration: 0.9,
            ...
            <div className="flex items-center gap-8">
              <a
                href="#contact"
                className="group relative px-10 py-5 bg-slate-900 text-white rounded-xl font-black text-xs uppercase tracking-widest overflow-hidden transition-all shadow-lg"
              >
              ...
              <div className="flex gap-6 border-l-2 border-slate-200 pl-8">
                <a
          ...
          >
            <div
              className="relative w-full max-w-[480px] aspect-4/5 overflow-hidden grayscale contrast-125 brightness-120"
              {...fadeIn({
                direction: "left",
                distance: 80,
                duration: 0.9,
      ...
      <section id="projects" className="py-40 px-6 lg:px-24">
        <div className="max-w-7xl mx-auto">
          <div className="mb-24 flex items-end justify-between border-b-2 border-slate-200 pb-12">
            <div>
              <h2
                className="text-6xl md:text-8xl font-black tracking-tighter uppercase text-slate-950"
                {...fadeIn({
                  direction: "right",
                  distance: 80,
                  duration: 0.9,
          ...
          <div className="flex overflow-x-auto gap-12 pb-20 snap-x no-scrollbar scroll-smooth">
                ...
                <div className="px-4">
                  <div className="flex gap-4 mb-6">
                    {project.tags.map((t) => (
                      <span
                        key={t}
                        className="text-[10px] font-black uppercase tracking-widest text-white bg-slate-900 px-3 py-1 rounded"
                      >
                        {t}
                      </span>
                    ))}
                  </div>
                  <h3 className="text-4xl font-black mb-4 text-slate-950">
                    {project.title}
                  </h3>
                  <p className="text-slate-600 text-lg font-medium leading-relaxed max-w-lg mb-8">
                    {project.description}
                  </p>
                  <div className="flex gap-6">
                    {project.tech.map((t) => (
                      <span
                        key={t}
                        className="text-[11px] font-mono text-slate-400 font-bold uppercase"
                      >
                        #{t}
                      </span>
                    ))}
          ...
          <div className="mt-48 mb-20 flex items-center gap-10">
            <h2
              className="text-3xl font-black tracking-tighter uppercase text-slate-950 whitespace-nowrap italic"
              {...fadeIn({
                direction: "right",
                distance: 80,
                duration: 0.9,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-24">
            {sideProjects.map((project, i) => (
              ...
              >
                <div className="text-slate-400 mb-10 group-hover:text-slate-900 transition-all duration-500">
                  {project.icon}
                </div>
                <h3
                  className="text-2xl font-black mb-4 text-slate-900"
                  {...fadeIn({
                    direction: "right",
                    distance: 80,
                    duration: 0.9,
                ...
                <div className="flex justify-between items-center pt-8 border-t border-slate-200">
                  <div className="flex gap-4">
                    {project.tech.map((t) => (
                      <span
                        key={t}
                        className="text-[10px] font-mono text-slate-400 uppercase font-black"
                      >
                        {t}
                      </span>
                    ))}
      ...
      <section id="about" className="py-40 px-6 lg:px-24 bg-slate-200/50">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-24">
          <div className="lg:col-span-7">
            ...
            <div className="mt-24 grid grid-cols-2 md:grid-cols-3 gap-16">
              {Object.entries(skills).map(([category, list]) => (
                <div key={category}>
                  <h4 className="text-[11px] uppercase tracking-[0.4em] text-slate-400 font-black mb-8 border-b-2 border-slate-300 pb-2">
                    {category}
                  </h4>
                  <ul className="space-y-4">
                    {list.map((skill) => (
                      <li
                        key={skill}
                        className="text-sm text-slate-600 flex items-center gap-3 font-bold"
                      >
          ...
          <div className="lg:col-span-5 space-y-10">
            <div className="bg-slate-900 p-12 rounded-[2.5rem] border border-slate-800 shadow-2xl">
              <h3 className="text-2xl font-black mb-12 flex items-center gap-4 text-white uppercase italic">
                <Trophy className="text-amber-400" size={28} /> Milestones
              </h3>
            ...
            <motion.div
              ...
              className="bg-white p-16 rounded-[3.5rem] border-2 border-slate-200 relative overflow-hidden group cursor-pointer shadow-lg"
            >
              <div className="relative z-10">
                <h3 className="text-4xl font-black mb-6 text-slate-950 leading-tight uppercase">
                  Resume.
                </h3>
              ...
              <BookOpen
                size={280}
                className="absolute right-[-60px] bottom-[-60px] opacity-5 text-slate-900 group-hover:rotate-12 transition-transform duration-1000"
              />
            </motion.div>
          </div>
        </div>
      ...
      <footer
        id="contact"
        className="py-48 px-6 lg:px-24 bg-slate-900 text-white relative overflow-hidden"
      >
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <h2 className="text-[15vw] font-black tracking-tighter mb-24 leading-none text-slate-800 select-none opacity-50">
            CONTACT
          </h2>
          ...
          <div className="flex flex-wrap justify-center gap-10 mb-40">
            {[
              ...
              <a
                key={idx}
                href={link.href}
                className="p-10 bg-slate-800 border border-slate-700 rounded-3xl transition-all duration-500 hover:scale-110 hover:bg-white hover:text-slate-900 shadow-xl"
              >
                {React.cloneElement(link.icon, { size: 32, strokeWidth: 1.5 })}
              </a>
            ))}
          </div>

          <div className="flex flex-col md:flex-row justify-between items-center gap-10 pt-24 border-t border-slate-800">
            <p className="text-slate-500 font-mono text-[10px] uppercase tracking-[0.5em] font-black">
              Faiz Zubair Vadakkayil / 2026
            </p>
            <div className="flex gap-12 text-[10px] uppercase font-black text-slate-400 tracking-widest">
