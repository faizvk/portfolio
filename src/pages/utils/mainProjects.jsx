export const mainProjects = [
  ...
  },
  {
    ...
    description:
      "AI SaaS dispatching across Gemini, GPT-4o, Claude 3.5, Groq + HuggingFace FLUX for images and ElevenLabs TTS — with Razorpay subscriptions and OAuth.",
    tech: ["React 19", "Node", "MongoDB", "Gemini", "HuggingFace"],
